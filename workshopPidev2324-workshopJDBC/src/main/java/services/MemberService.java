...
public class MemberService {
        ...
        try (PreparedStatement ps = connection.prepareStatement(query)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    membre.setNom(rs.getString("last_name"));
                    membre.setPrenom(rs.getString("first_name"));
    ...
    public List<Membre> findMembresByEquipe(int idEquipe) throws SQLException {
        List<Membre> membres = new ArrayList<>();
        ...
        return membres;
    }  public List<Membre> findExternMembresByEquipe(int idEquipe) throws SQLException {
        List<Membre> membres = new ArrayList<>();
